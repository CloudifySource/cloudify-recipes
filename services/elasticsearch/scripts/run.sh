...
clusterName="$2"
echo "elasticsearch clusterName is ${clusterName}"
...
echo "About to invoke ${binFolder}/elasticsearch -f -Des.cluster.name=${2} ..."
${binFolder}/elasticsearch -f -Des.cluster.name=${2}
