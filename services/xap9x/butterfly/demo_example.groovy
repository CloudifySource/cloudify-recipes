...
public class Demo
{
    ...
    private String getRemoteSpaceURL() {
        return "jini://*/*/myDataGrid?locators=10.248.123.58:4242";
    }
    ...
    public void run(GigaSpace gigaSpace) throws Exception {
		...
		gigaSpace.getTypeManager().registerTypeDescriptor(new SpaceTypeDescriptorBuilder(EngineerPojo.class, null).create())
...
def lookuplocators = "10.248.123.58:4242"
